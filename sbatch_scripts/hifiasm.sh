...
# Usage: sbatch script.sh sample_name file1.bam file2.bam file3.bam
...
srun docker run --rm -u $(id -u):$(id -g) -v $(pwd):/workspace -w /workspace meredith705/hifiasm@sha256:c86d7f2750a52a75814828462fe4d6dad5d3980c95ddadb6ed62af629a17aad7 hifiasm \
                                                                                                                                        -t 96 \
                                                                                                                                        --ont \
                                                                                                                                        -o $sample_name.hifiasm.ont \
                                                                                                                                        ${sample_name}.merged.fastq 2> $sample_name.hifiasm.log
